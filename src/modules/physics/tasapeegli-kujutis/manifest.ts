...
export const manifest = defineModule({
  ...
  // seega patch.
  // 1.0.2: theory-1 joonisele (tp-nailine-kujutis) lisati „samm lähemale"
  // joonis (StepCloserFigure) VirtualImageFigure'i juurde – visuaali
  ...
  // Kaks uut kordamiskaarti (graph, transfer), 5 → 7 tk.
  version: "2.0.0",
  status: "active",
});
